...
const { getQSDEPDateSurvey, getShortMonth } = require('lib/file-survey-helper')
...
//  *
//  * @param {*} searchUrl URL to search.
//  * @return {string} Partial link file.
//  */
// const getLinkFromUrl = async (searchUrl) => {
...
// /**
//  * Save locally a file from a given link URL.
//  *
//  * @param {string} linkUrl Link file to download.
//  * @param {string} dir Local out directory
//  * @param {string} outputFilename File name used when saving.
//  * @return {string} Full path of the file.
//  */
// const saveFileFromUrl = async (linkUrl, dir, outputFilename) => {
//   const response = await axios.request({
...
//   if (response.status === httpStatus.OK) {
//     fullPath = path.resolve(__dirname, dir, outputFilename)
